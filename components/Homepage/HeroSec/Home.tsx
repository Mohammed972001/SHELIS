...
const HomeComponent: React.FC = () => {
  ...
  <div className="flex items-center justify-between pt-20 text-text">
    ...
    <div className="flex flex-col gap-20 mt-40 md:gap-16 md:mt-32 lg:gap-18 lg:mt-36">
      ...
      <h3 className="font-bold leading-none tracking-normal uppercase font-satoshi md:text-lg xl:text-2xl">ELEVATE YOUR STYLE WITH<br/>LUXURY OUTFITS</h3>
      <div>
    ...
    <div className="relative flex flex-col items-center">
      ...
      <div className="relative flex justify-center w-full">
        <div className="absolute bg-primary w-[280px] h-[390px] xl:w-[416px] xl:h-[502px] rounded-md top-[50px] z-10"></div>

        <Image
          src="/home/HeroSecIcone.png"
          alt="model"
          className="relative z-40 -mt-12 md:w-[230px] md:h-[490px] xl:w-[320px] xl:h-[596px]"
          width={320}
          height={596}
        />
      </div>
